...
class _OpeningState extends State<Opening> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    DotsIndicator(
                      ...
                      decorator: DotsDecorator(activeColor: Theme.of(context).primaryColor),
                    ),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        Text(
                          'Not Registered ?',
                          style: TextStyle(
                              color: Color.fromRGBO(136, 98, 4, 1), fontSize: 15),
                        ),
                        InkWell(
                          onTap: () {
                                ...
                                builder: (_) {
                                  return Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        buildButtonTheme(w,h, context, 'Borrower',_gotosignupBorrower),
                                        Text('or'),
                                        buildButtonTheme(w, h,context, 'Library',_gotosignupLib),
                                      ],
                                    ),
                                  );
                                });
  ...
  Widget buildButtonTheme(double w,double h, BuildContext context, String txt,Function ToDo) {
    return Container(
