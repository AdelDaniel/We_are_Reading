...
class _OpeningState extends State<Opening> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  buildButtonTheme(w,h, context, 'Login'),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: <Widget>[
                      Text(
                              ...
                              builder: (_) {
                                return Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      buildButtonTheme(w,h, context, 'Borrower'),
                                      Text('or'),
                                      buildButtonTheme(w, h,context, 'Library'),
                                    ],
                                  ),
                                );
                              });
  ...
  Widget buildButtonTheme(double w,double h, BuildContext context, String txt) {
    return Container(
