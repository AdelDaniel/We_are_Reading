...
class RequestsInternalWidget extends StatelessWidget {
//  final String id;
//  final String bName;
//  final String imageName;
//  final String bAuther;
//  final String libName;
//  RequestsInternalWidget({
//    this.libName,
//    this.id,
//    this.bName,
//    this.imageName,
...
////            ),
////          ),
//          Padding(padding: EdgeInsets.only(bottom: ScreenUtil().setWidth(4))),
//        ],
//      ),
//    );
...
//                    crossAxisAlignment: CrossAxisAlignment.center,
//                    children: <Widget>[
//                      Text('دقات الشامو',textAlign: TextAlign.center,style: TextStyle(color: Color.fromRGBO(63,61,86, 1),),),
//                      Text('عمرو عبدالحميد',textAlign: TextAlign.center,style: TextStyle(color: Color.fromRGBO(63,61,86, 1),),),
//                       Text('Maktabt Masr',textAlign: TextAlign.center,style: TextStyle(color: Color.fromRGBO(63,61,86, 1),),),
//                    ],
//                  ),
//                ),
//              ),
...
//        RaisedButton(
//          onPressed: () {},
//          child: Text('Cancel Request',style: TextStyle(color: Color.fromRGBO(211,47,47,1),),),
//          shape: RoundedRectangleBorder(
//            borderRadius: BorderRadius.circular(30),
//          ),
//          color:Color.fromRGBO(255,255,255,1),
